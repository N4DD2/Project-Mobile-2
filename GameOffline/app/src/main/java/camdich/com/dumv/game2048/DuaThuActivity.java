...
public class DuaThuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dua_thu);
        AnhXa();
        ...
        final CountDownTimer countDownTimer = new CountDownTimer(60000 , 300) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if(sbrMot.getProgress() >= sbrMot.getMax()){
                    ...
                    Toast.makeText(DuaThuActivity.this, "One Win" , Toast.LENGTH_SHORT).show();
                    if(chkMot.isChecked()){
                        soDiem += 10;
                        Toast.makeText(DuaThuActivity.this, "Bạn đoán chính xác" , Toast.LENGTH_SHORT).show();
                    } else{
                        soDiem -= 5;
                        Toast.makeText(DuaThuActivity.this, "Bạn đoán sai rồi" , Toast.LENGTH_SHORT).show();
                    }
                    txtDiem.setText(soDiem +"");
                    EnableCheckBox();
                ...
                if(sbrHai.getProgress() >= sbrHai.getMax()){
                    ...
                    Toast.makeText(DuaThuActivity.this, "Two Win" , Toast.LENGTH_SHORT).show();
                    if(chkHai.isChecked()){
                        soDiem += 10;
                        Toast.makeText(DuaThuActivity.this, "Bạn đoán chính xác" , Toast.LENGTH_SHORT).show();
                    } else{
                ...
                if(sbrBa.getProgress() >= sbrBa.getMax()){
                    ...
                    Toast.makeText(DuaThuActivity.this, "Three Win" , Toast.LENGTH_SHORT).show();
                    if(chkBa.isChecked()){
                        soDiem += 10;
                        Toast.makeText(DuaThuActivity.this, "Bạn đoán chính xác" , Toast.LENGTH_SHORT).show();
                    } else{
        ...
        ibntPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(chkMot.isChecked() || chkHai.isChecked() || chkBa.isChecked()){
                    ...
                    Toast.makeText(DuaThuActivity.this, "Vui lòng đặt cược trước khi chơi" , Toast.LENGTH_SHORT).show();
                }
